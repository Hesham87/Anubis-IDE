...
class CsharpHighlighter(QSyntaxHighlighter):
    ...
    keywords = ['case', 'catch'
        ...
        , 'do', 'double', 'else', 'enum'
        , 'event', 'explicit', 'extern', 'while'
        , 'continue', 'decimal', 'object', 'operator'
        , 'finally', 'fixed', 'float', 'for'
        , 'stackalloc', 'static', 'string'
        , 'foreach', 'goto', 'if', 'implicit'
        , 'in', 'int', 'interface', 'internal'
        , 'is', 'lock', 'long', 'namespace'
        , 'new', 'break', 'byte', 'null', 'default', 'delegate'
        , 'out', 'override', 'params', 'private'
        , 'protected', 'public', 'readonly', 'ref'
        , 'return', 'sbyte', 'sealed', 'short'
        , 'virtual', 'void', 'volatile''sizeof'
        , 'struct', 'switch', 'this', 'throw'
        , 'true', 'try', 'typeof', 'uint'
        , 'ulong', 'unchecked', 'unsafe', 'ushort'
        , 'using', 'false', 'base', 'bool', 'var', 'abstract', 'as']
